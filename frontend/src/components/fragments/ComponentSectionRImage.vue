...
<template>
  <div class="relative w-full grid gap-6 lg:grid-cols-2">
    <!-- Text Section -->
    <div class="w-full flex justify-center items-center px-5 xl:px-0">
      <div class="sm:max-w-[480px] text-center sm:text-left text-container">
        ...
        <div class="button-wrapper" v-if="props.content.showButton">
    ...
    <div class="overflow-hidden flex justify-center items-center w-full">
      <div class="sm:max-w-[450px] md:max-w-full">
        <!-- Video component (if hasVideoVersion is true) -->
        <video v-if="content.hasVideoVersion"
        ...
        <!-- Picture element for non-video content -->
        <picture v-else>
